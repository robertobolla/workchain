    ...
    <div className="deznav">
      <div className="deznav-scroll">
          ...
          {userType == "Patient" && (
            <li>
              <a
                className="ai-icon"
                aria-expanded="false"
                onClick={() => setOpenComponent("Doctor2")}
              >
                <i>
                  <CgBriefcase />
                </i>
        ...
        <div className="plus-box">
          <p className="fs-16 font-w500 mb-1">Check our roadmap</p>
        ...
        <div className="copyright">
          <p className="fs-14 font-w200">
            <strong className="font-w400">Work Chain Dashboard</strong>© 2024
            All Rights Reserved
          </p>
          <p className="fs-12">Made by @escaleweb3_devs</p>
        </div>
      </div>
    </div>
  );
